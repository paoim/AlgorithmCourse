...
/**
 * The <tt>QuickFindUF</tt> class represents a union-find data structure. It
 ...
 * <em>N</em> objects takes linear time. Afterwards, <em>find</em>,
 * <em>connected</em>, and <em>count</em> takes constant time but <em>union</em>
 * takes linear time.
 * <p>
